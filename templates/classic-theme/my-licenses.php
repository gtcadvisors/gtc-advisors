...
<li class="nav-item">
<a class="nav-link" href="<?php url("CERTIFICATES") ?>"><?php _e("My Certificates") ?> </a>
</li>
<li class="nav-item">
<a class="nav-link active" href="<?php url("LICENSES") ?>"><?php _e("My Licenses") ?></a>
</li>
</ul>
</nav>
...
<div class="col-auto">
<a href="<?php url("ADD-LICENSE") ?>" class="btn btn-primary btn-rounded"><i class="fas fa-plus"></i> <?php _e("Add New License") ?></a>
</div>
</div>
</div>
<div class="card-body">
...
<td><img src="<?php _esc($config['site_url']);?>storage/licenses/<?php _esc($item['filename'])?>" style="max-width:70px;" alt="<?php _esc($item['certificate_name'])?>"></td>
<td><?php _esc($item['license_name'])?></td>
<td><?php _esc($item['license_from'])?></td>
<td><?php _esc($item['license_number'])?></td>
<td>
<div class="action">
<a href="<?php _esc($config['site_url']);?>storage/licenses/<?php _esc($item['filename'])?>" title="<?php _esc($item['filename'])?>" target="_blank" class="file-circle me-2"><i class="fas fa-cloud-download-alt"></i></a>
<a href="<?php url("EDIT-LICENSE") ?>/<?php _esc($item['id'])?>" class="file-circle me-2"><i class="fas fa-pen"></i></a>

<a href="#" class="file-circle ico ajax-delete-license" data-tippy-placement="top" title="<?php _e("Delete") ?>"><i class="fas fa-trash-alt"></i></a>
</div>
</td>
<?php }
}else{ ?>
<tr>
<td colspan="15" class="text-center"><?php _e("No License found.") ?></td>
</tr>
<?php } ?>
</tbody>
</table>
