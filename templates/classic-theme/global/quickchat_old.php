...
<div id="wchat">
    <div class="wchat-wrapper wchat-wrapper-web wchat-wrapper-main">
        ...
        </span><span class="pane wchat-three" style="transition: all 0.3s ease;"><span class="flow-drawer-container" style="transform: translateX(0px);border: 1px solid rgba(0, 0, 0, .08);display:block;">
                    ...
                    <div id="contact-list">
                        <header class="wchat-header wchat-chat-header top">
                            <div class="chat-avatar">
                              ...
                              <img src="<?php _esc($config['site_url'])?>storage/profile/<?php _esc($userimg)?>" class="avatar-image is-loaded" width="100%"></div>
                                </div>
                            </div>
                            <div class="chat-body">
                              <div class="chat-main">
                              <h2 class="chat-title" dir="auto">
                              <span class="wchatellips personName"><?php _esc($username)?></span></h2>
                                </div>
                            </div>
                        </header>
                        <div class="form-material">
                        <input class="form-control p-lr-20 live-search-box search_bg" id="searchbox" type="text" placeholder="<?php _e("Search By Username or Email") ?>">
                        </div>
