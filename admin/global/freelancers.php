        ...
        <div class="card">
            ...
            <div class="card-block">
                <div id="js-table-list">
                    <table id="ajax_datatable" data-jsonfile="freelancers.php" class="js-table-checkable table table-vcenter table-hover" data-tablesaw-mode="stack" data-plugin="animateList"
                        ...
                        <tr>
                            ...
                            <th><i class="ion-image"></i> Freelancer</th>
                            <th class="w-10">Type</th>
                            <th class="w-10">Email</th>
                            <th class="hidden-xs w-30" style="width: 100px;">Category</th>
