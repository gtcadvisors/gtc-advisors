...
<head>
  ...
  <body style="background-color:#f0faff;border-bottom: 0px !important;"> 
          ...
          <div class="row login-register-cover">
            <div class="col-lg-4 col-md-8 col-sm-12 col-11 mx-4 mx-md-auto mx-lg-auto bg-white mb-100 pb-20 pl-60 pt-35 pr-60" id="login-register">
              <div class="text-center">
               <h6 class="mb-20 text-brand-1" style="font-style:normal;"> <?php _e("Forgot Password Your Global Tax Compliance ?") ?></h6>      
               <?php
                if($success != ''){
              ...
              <form method="post" class="login-register text-start mt-20"> 
                <div class="form-group"> 
                  <input class="form-control" id="input-2" id="username" type="email" required="" name="email" placeholder="<?php _e("Email Address") ?>">
                </div> 
                <div class="login_footer form-group d-flex justify-content-between">
                  
                </div>
                <div class="form-group">
                  <button class="btn btn-brand-1 hover-up w-100" type="submit" name="submit" style="background-color:#2C76DC;font-family:'Proxima Soft';"><?php _e("Request Password") ?></button>
                </div>
              </form>
            </div>
         </div>
