          ...
          <div class="row login-register-cover">
            <div class="col-lg-4 col-md-8 col-sm-12 col-11 mx-4 mx-md-auto mx-lg-auto bg-white mb-100 pb-20 pl-60 pt-35 pr-60" id="login-register">
              <div class="text-center">
               <h6 class="mb-20 text-brand-1" style="font-style:normal;"> <?php _e("Change Your Password") ?></h6> 
               <?php
                if($forgot_error != ''){
              ...
              <strong><?php _e("Username") ?> : </strong> <?php _esc($username) ?>
                ...
                <div class="form-group"> 
                  <input class="form-control" id="input-2" id="password" type="password" required="" name="password" placeholder="<?php _e("Password") ?>">
                </div> 
                <div class="form-group"> 
                 <input class="form-control" id="input-2" id="password2" type="password" required=""  name="password2" placeholder="<?php _e("Confirm Password") ?>" oninput="toggleFunc()">
                  </div>
                ...
                <div class="form-group">
                  <button class="btn btn-brand-1 hover-up w-100" type="submit" name="submit" style="background-color:#2C76DC;font-family:'Proxima Soft';"><?php _e("Change Password") ?></button>
                </div>
