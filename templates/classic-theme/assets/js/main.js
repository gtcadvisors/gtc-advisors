...
var swiper = new Swiper(".slide-content", {
  ...
  //Function for the drop_down of the filters
  function show_down(type){
    var e = document.getElementById("expertise");
    var i = document.getElementById("industry");
  ...
  function show_faq(question){
    var a = document.getElementById("faq_1");
    var b = document.getElementById("faq_2");
    var c = document.getElementById("faq_3");
    var d = document.getElementById("faq_4");
    var e = document.getElementById("faq_5");
    var f = document.getElementById("faq_6");
    if(question == 1){
  ...
  // THE FILTER BUTTON DISPLAY AND CLOSE CONTROLS
