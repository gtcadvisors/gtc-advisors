...
<li class="nav-item">
<a class="nav-link active" href="<?php url("RESUMES") ?>"><?php _e("My Resumes") ?></a>
</li>
<li class="nav-item">
...
<div class="col-auto">
<a href="<?php url("ADD-RESUME") ?>" class="btn btn-primary btn-rounded"><i class="fas fa-plus"></i> <?php _e("Add New Resume") ?></a>
</div>
</div>
</div>
<div class="card-body">
...
<td><?php _esc($item['id'])?></td>
<td><?php _esc($item['filename'])?></td>
<td><?php _esc($item['name'])?></td>
<td>
<div class="action">
<a href="<?php _esc($config['site_url']);?>storage/resumes/<?php _esc($item['filename'])?>" title="<?php _esc($item['filename'])?>" target="_blank" class="file-circle me-2"><i class="fas fa-cloud-download-alt"></i></a>
<a href="<?php url("EDIT-RESUME") ?>/<?php _esc($item['id'])?>" class="file-circle me-2"><i class="fas fa-pen"></i></a>
